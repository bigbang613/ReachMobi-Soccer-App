...
public class SelectedTeamActivity extends AppCompatActivity {
    ...
    private void saveTeamInfo() {
        ...
        intent.putExtra("homeTeam", homeTeam.getText());
        intent.putExtra("homeScore", homeScore.getText());
        intent.putExtra("date", date.getText());
        intent.putExtra("awayTeam", awayTeam.getText());
        intent.putExtra("awayScore", awayScore.getText());
    }
    ...
    if (requestCode == Constants.REQUEST_TEAM){
